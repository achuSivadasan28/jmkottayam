            ...
            <div class="canvas">
                ...
                <div class="dashboardPage">
                    <div class="dashboardMenuList">
						...
						<a href="tax_slabreport.php" class="dashboardMenuBox">
                            <div class="dashboardMenuBoxIcon">
                                <i class="uil uil-file-medical-alt"></i>
                            </div>
                            <div class="dashboardMenuBoxDetails">
                                <h2>TaxSlab Report</h2>
                            </div>
                        </a>
						
						<a href="creditreport.php" class="dashboardMenuBox">
                            <div class="dashboardMenuBoxIcon">
                                <i class="uil uil-file-medical-alt"></i>
                            </div>
                            <div class="dashboardMenuBoxDetails">
						...
						<a href="hsn_report.php" class="dashboardMenuBox">
                            ...
                            <div class="dashboardMenuBoxDetails">
                                <h2>HSN Sales Report</h2>
                            </div>
                        </a>
						<a href="hsn_reportb2.php" class="dashboardMenuBox">
                            <div class="dashboardMenuBoxIcon">
                                <i class="uil uil-percentage"></i>
                            </div>
                            <div class="dashboardMenuBoxDetails">
                                <h2>HSN Sales Report (Credit Note)</h2>
                            </div>
                        </a>
						<a href="hsn_report_summery.php" class="dashboardMenuBox">
                            <div class="dashboardMenuBoxIcon">
                                <i class="uil uil-percentage"></i>
                            </div>
                            <div class="dashboardMenuBoxDetails">
                                <h2>HSN Report Summary</h2>
                            </div>
                        </a>
