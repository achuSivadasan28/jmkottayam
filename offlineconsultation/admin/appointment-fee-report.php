...
<!-- delete alert  -->
            ...
            <div class="canvas">
				...
				<div class="reportBoxListSection">
					<div class="reportBoxList" style="background: cornflowerblue; color: white;display:flex;flex-direction:row;justify-content:space-between;">
					    <div>
							<h1 id="gpay_amt_data">0000</h1>
							<p>Fee from new patients</p>
						</div>
						<div>
							<h1 id="new_patients">00</h1>
					...
					<div class="reportBoxList" style="background: coral; color: white;display:flex;flex-direction:row;justify-content:space-between;">
						<div>
							<h1 id="cash_tax_data">0000</h1>
							<p>Fee from renew patients</p>
						</div>
						<div>
							<h1 id="renew_patients">00</h1>
							<p>Total renew patients</p>
						</div>
					</div>
					<div class="reportBoxList" style="background: forestgreen; color: white;display:flex;flex-direction:row;justify-content:space-between;">
						<div>
							<h1 id="card_amt_data">0000</h1>
							<p>Fee from online patients</p>
						</div>
						<div>
							<h1 id="online_patients">00</h1>
							<p>Total online patients</p>
						</div>
					</div>
					<div class="reportBoxList" style="background: forestgreen; color: white;">
						<h1 id="tmt_amt_data">0000</h1>
						<p>Total</p>
					</div>
				</div>
				<div class="reportBoxListSection">
					<div class="reportBoxList" style="background: cornflowerblue; color: white;display:flex;flex-direction:row;justify-content:space-between;">
						<div>
							<h1 id="trtment_amnt">0000</h1>
							<p>Total Treatment Fee</p>
						</div>
						<div>
							<h1 id="treatment_count">00</h1>
    ...
    <!-- script  -->
        ...
        ?>
    <!-- script close -->
<script src="assets/appointment/fetch-appointmentfeereports.js?v=<?php echo $version_variable;?>"></script>
