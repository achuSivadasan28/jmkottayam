                ...
                <div class="consultingWindow">
					<div class="consultingWindowNextSextion">
						<div style="display:none" class="consultingWindowNextSextionBox secound_consultingNextBtn1">
							...
							<button style="border: none; outline: none;" class="consultingNextBtn secound_consultingNextBtn button_disabled_status">Next</button>
						</div>
					</div>
        ...
        <div class="commentsPopup" style="display:none">
            ...
            <div class="commentsPopupMain">
				<div class="commentsPopupTabBtnArea">
					<button class=" tablink active" onclick="openCity2(event,'tab1')">Prescription</button>
					<!--<button class="tablink" onclick="openCity2(event,'tab2')">Comments</button>-->
					<button class="tablink" onclick="openCity2(event,'tab3')">History</button>
					<!--<button style="margin-left: auto;" class="tablink" onclick="openCity2(event,'tab4')">Medical History</button>
					<button class="tablink" onclick="openCity2(event,'tab5')">Surgical History</button>-->
				</div>
				...
				<div class="commentsTextarea">
					<label>Remark</label>
					<textarea id="main_remark"></textarea>
				</div>
				</div>
        ...
        <!-- comments popup close -->
                    <div class="consultAppointmentList">
                        <div class="consultAppointmentListTab">
                            <button class="tablinks" style="display: none;" onclick="openCity(event, 'appointmentTab1')">Appointments</button>
                            <button class="tablinks active" onclick="openCity(event, 'appointmentTab2')" id="defaultOpen"><div class="WaitingCount">0</div>  Waiting List</button>
                        </div>
                        <div id="appointmentTab1" class="tabcontent">
                        ...
                        <div id="appointmentTab2" class="tabcontent" style="display: block;">
                            <div class="consultAppointmentListTable">
                                <div class="consultAppointmentListTableHead">
                                    <div class="searchBox">
...
<input type="hidden" class="position" value=${position_data}>
		...
		//delete alert 
		$('.prescriptionHistoryDeleteBtn').click(function(){
			$('.deleteAlert').fadeIn();
			$('.shimmer').fadeIn();
		});
	...
	<script src="assets/appointment/fetch_all_todays_appointment_watting_list.js?v=<?php echo $version_variable;?>"></script>
