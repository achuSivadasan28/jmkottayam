...
$.ajax({
	url:"action/hsn_report_datab2.php",
	type:"POST",
	...
	success:function(result_data){
		...
		for(let x = 0;x<result_data_json.length;x++){
			...
			$('.export_reports').css('pointer-events','none')
		}
...
$('body').delegate('.export_reports','click', function(e){
	...
	window.location.href="action/export_hsn_report_credit.php?start_date="+start_date+"&end_date="+end_date+"&search_data="+search_data;
