        ...
        <section id="dashboard">
            ...
            <div class="canvas">
				...
				<div class="reportBoxListSection">
					<div class="reportBoxListTitle">HSN Report Summary</div>
...
<script src="js/hsn_report_summery.js?v=<?php echo $version_variable;?>"> </script>
