...
<!-- toaster close -->
        ...
        <section id="dashboard">
            ...
            <div class="canvas">
                ...
                <div class="canvasHead">
                    <div class="canvasHeadBox1">
                        ...
                        <div class="breadCrumbs">
                            <a href="branch-management.php" class="back"><i class="uil uil-angle-left-b"></i></a>
                            <span>/</span>
                            <a href="branch-management.php">Branch Management</a>
                        </div>
                    </div>
                </div>
                <!-- canvas head close -->
                ...
                <div class="formWraper">
                    <form action="" id="edit_branch">
                        <div class="formGroup">
                            <label for="">Branch Name</label>
                            <input type="text" value="" id="branch_name">
                        </div>
                        ...
                        <div class="formBtnArea">
                            <button id="edit_branch_btn">Save</button>
                        </div>
                    </form>
                </div>
                <!-- form section close -->
    ...
    ?>
	<script src="assets/branch/edit-branch.js?v=<?php echo $version_variable;?>"></script>
    <!-- script close -->
