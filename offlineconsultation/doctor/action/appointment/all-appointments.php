...
if($check_security == 1){
	...
	if($login_id == 86){
	   ...
	   $doctor_where = "doctor_id='$login_id' and";
	}
	$select_todays_appointment = $obj->selectData("count(id) as id","tbl_appointment","where  $doctor_where status!=0 and tbl_appointment.cross_branch_status!=1");
