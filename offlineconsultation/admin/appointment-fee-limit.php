...
<body>
                ...
                <div class="formWraper">
                    <form action="" id="add_appointment">
						 ...
						 <div class="formGroup">
                            ...
                            <input type="number" id="appointment" disabled>
                        </div>
						<div class="formGroup">
                            <label for="">Limit(Visit)</label>
                            <input type="number" id="max_visit_data" required>
                        </div>
						<div class="formGroup">
                            <label for="">Limit(month)</label>
                            <input type="number" id="month_limit" required>
                        </div>
						
						<div class="formGroup">
                            <label for="">Renewal Fee</label>
                            <input type="number" id="nr_appointment" disabled>
                        </div>
						<div class="formGroup">
                            <label for="">Limit(month)</label>
                            <input type="number" id="nr_month_limit" required>
                        </div>
    ...
    <!-- script  -->
        ...
        ?>
	<script src="assets/appointmentFee/appointment-fee-limit.js?v=<?php echo $version_variable;?>"></script>
    <!-- script close -->
