...
function fetch_patient_count(){
	$.ajax({
		url:"../action/consulted_patient_count-prescription.php",
		type:"POST",
...
function fetch_patient_data(){
	$.ajax({
	url:"../action/consulted_patient_details-prescription.php",
	type:"POST",
	data:{search_val:search_val,
				...
				$('.consultAppointmentListTableBody table tbody').append(`<tr>
                                                    ...
                                                    <td data-label="Action">
                                                        <div class="tableBtnArea">
															...
															<a href="patients-profile.php?patient_id=${result_json[x1]['patient_id']}/${result_json[x1]['branch']}" class="tableViewBtn" title="View"><i class="uil uil-eye"></i>
                                                            </a>
