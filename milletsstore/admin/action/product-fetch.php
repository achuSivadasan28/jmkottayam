...
$fetch_data = $obj1->selectData("id,product_name,category_id,price,discount,quantity","tbl_product","where status!=0 $search_where ORDER BY product_name ASC limit $limit");
