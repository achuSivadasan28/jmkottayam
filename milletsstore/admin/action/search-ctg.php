...
$id=$_GET['id'];
$fetch_data = $obj1->selectData("id,product_name,category_id,price,discount,quantity","tbl_product","where status!=0 and category_id=$id $search_where ORDER BY id DESC");
