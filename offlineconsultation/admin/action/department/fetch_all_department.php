...
if($check_security == 1){
	...
	if($search_val != ''){
		$where_search = " and department_name like '%$search_val%'";
	}
	$select_all_branch = $obj->selectData("id,department_name","tbl_department","where status!=0  $where_search ORDER BY id DESC limit $limit_range");
