...
<body>
        ...
        <section id="dashboard">
            ...
            <div class="canvas">
                ...
                <div class="canvasHead">
                    <div class="canvasHeadBox1">
                        ...
                        <div class="breadCrumbs">
                            ...
                            <span>/</span>
                            <a href="payment-option.php">API</a>
                        </div>
                    </div>
                </div>
                <!-- canvas head close -->
                ...
                <div class="formWraper">
                    <form action="" id="add-api">
                        <div class="formGroup">
                            <label for="">API</label>
                            <input type="text" id="w_api" required>
    ...
    ?>
	<script src="js/add-whatsapp-api.js?v=<?php echo $version_variable;?>"></script>
    <!-- script close -->
