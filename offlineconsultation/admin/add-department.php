...
<!-- toaster close -->
        ...
        <section id="dashboard">
            ...
            <div class="canvas">
                ...
                <div class="formWraper">
                    <form action="" id="add-department">
                        <div class="formGroup">
                            <label for="">Department Name</label>
                            <input type="text" required id="department_name">
                        </div>
                        ...
                        <div class="formBtnArea">
                            <button id="add-department-btn">Save</button>
                        </div>
                    </form>
                </div>
                <!-- form section close -->
    ...
    ?>
	<script src="assets/department/add-department.js?v=<?php echo $version_variable;?>"></script>
    <!-- script close -->
