        ...
        <section id="dashboard">
            ...
            <div class="canvas">
				...
				<div class="reportBoxListSection">
					<div class="reportBoxList" style="background:#307f75; color: white;">
						<h1 id="actual_amt_data" ></h1>
						<p>Actual Amount</p>
					</div>
					<div class="reportBoxList" style="background: #7f3330; color: white;">
						<h1 id="total_tax_data"></h1>
						<p>Total Tax Amount</p>
					</div>
					<div class="reportBoxList" style="background: #71307fd1; color: white;">
                    ...
                    <div class="consultAppointmentList">
                        <div class="tabcontent" style="display: block;">
                            <div class="consultAppointmentListTable">
                        		...
                        		<a href="" class="addBtn export_reports">Export Exel</a>
                                </div>
...
<script src="js/invoice.js?v=<?php echo $version_variable;?>"> </script>
