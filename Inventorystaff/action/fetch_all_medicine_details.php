...
$urlv = $_POST['urlv'];
$response_arr = array();
$select_medicine_details = $obj->selectData("id,no_of_pills,price,hsn_sac,batch,expiry_date,discount,quantity,tax_data","tbl_medicine_details","where status!=0 and product_id=$urlv and quantity>0");
