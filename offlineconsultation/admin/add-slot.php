...
<!-- toaster close -->
                ...
                <div class="formWraper">
                    <form action="" id="add-slot">
                        ...
                        <div class="formGroup">
                            ...
                            <input type="number" id="no_of_slot" required>
                        </div>
                        ...
                        <div class="formBtnArea">
                            <button id="slot_btn">Save</button>
                        </div>
                    </form>
                </div>
                <!-- form section close -->
    ...
    ?>
	<script src="assets/timeSlot/add-slot.js?v=<?php echo $version_variable;?>"></script>
    <!-- script close -->
