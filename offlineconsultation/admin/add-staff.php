...
<!-- toaster close -->
                ...
                <div class="formWraper">
                    <form action="" id="addstaff">
                        ...
                        <div class="formGroup">
                            ...
                            <select name="" id="branch_name" required>
						...
						<div class="formGroup">
                            ...
                            <select name="" id="role_data" required>
								<option value="staff">Appointment Staff</option>
                        ...
                        <div class="formBtnArea">
                            <button id="add-staff-btn">Save</button>
                        </div>
                    </form>
                </div>
                <!-- form section close -->
    ...
    ?>
	<script src="assets/staff/add-staff.js?v=<?php echo $version_variable;?>"></script>
