...
if($check_security == 1){
		...
		$select_appointment_details = $obj->selectData("tbl_appointment.id,tbl_appointment.patient_id,tbl_appointment.branch_id,tbl_appointment.doctor_id,tbl_appointment.appointment_date,tbl_appointment.height,tbl_appointment.weight,tbl_appointment.blood_pressure,tbl_appointment.allergies_if_any,tbl_appointment.current_medication,tbl_appointment.first_visit,tbl_appointment.present_Illness,tbl_appointment.any_surgeries,tbl_appointment.any_metal_Implantation,tbl_appointment.appointment_number,tbl_appointment.appointment_time_slot_id","tbl_appointment","where tbl_appointment.id=$url_val");
