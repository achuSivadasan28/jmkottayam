...
<body>
                    ...
                    <tfoot>
                       ...
                       <!-- <tr style="page-break-inside: avoid; page-break-after: auto;">
                        ...
                        <tr style="page-break-inside: avoid; page-break-after: auto; border-top: 1px solid black;">
                            <td colspan="2"><b id="amt_in_words"></b> - Inclusive Of All Taxes</td>
                        </tr>
                    </tfoot>
                </table>
            </div>
        ...
        <section id="dashboard">
            ...
            <div class="canvas">
                ...
                <div class="formWraper">
                    ...
                    <div class="customeInputArea customer_medicine_details">
                            <div class="formGroup">
    ...
    <script src="js/generatebills.js?v=<?php echo $version_variable;?>"> </script>
...
$(".add_more_payment_details").click(function(e) {
                e.preventDefault();
	let payment_option_temp = `<div class="customeInputArea dynamic_product_p">
						<div class="formGroup">
                           <label for="">Payment Option</label>
							<select class="payment_option" required>`;
