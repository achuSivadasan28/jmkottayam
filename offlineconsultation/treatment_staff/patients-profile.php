...
<body>
      ...
      <!-- print design  -->
		<div class="printPage">
			<div class="printPageHead">
				<h1><div class="printPageHeadLogo"><img src="assets/images/johnmariansLogo.png" alt=""></div> WELLNESS CLINIC</h1>
			...
			<div class="printPageFooter">
				<h1><div class="printPageFooterLogo"><img src="assets/images/johnmariansLogo.png" alt=""></div> WELLNESS HOSPITAL</h1>
    ...
    <main>
     ...
     <div class="basicDetails">
		 <div class="bdLeft">
			 <img src="assets/images/avatar1.jpg" alt="image"/>
		 </div>
		 <div class="bdRight">
			  <div class="bdDetails">
				...
				<div class="consultationPopup">
					...
					<div class="complaintsMain">
						...
						<div class="remarksBox">
							<p class="presTitle" id="all_remark">Remarks</p>
							<!--<span class="remarks">
								test
							</span>-->
													</div>
