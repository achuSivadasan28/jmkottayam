...
$.ajax({
	url:"action/tax_report_data.php",
	type:"POST",
...
$('body').delegate('.export_reports','click', function(e){
	...
	window.location.href="action/export_tax_invoice_report.php?start_date="+start_date+"&end_date="+end_date+"&search_data="+search_data;
