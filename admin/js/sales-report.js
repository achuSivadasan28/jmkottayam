...
function fetch_bill_count(){
	...
	$.ajax({
		url:"action/fetch_bill_count_sales.php",
		type:"POST",
...
fetch('action/sales_invoice.php?search_val='+search_val+'&start_date='+start_date+'&end_date='+end_date+'&status_id='+status_id+'&limit_range='+limit_range)
   ...
   for(let x=0;x<data.length;x++){
	    si_No++;
                       ...
                       <td data-label="Quantity">
						...
						<td data-label="Hsn Number">
                            <p>${data[x]['hsn_number']}</p>
                        </td>
						<td data-label="Tax In Per">
                            <p>${data[x]['tax_in_per']} %</p>
                        </td>
                        <td data-label="Date">
                            <p>${data[x]['date']}</p>
                        </td>
...
.then(() => {
	...
	$('.export_reports').attr('href', 'action/export_all_sales_reports.php?search_val='+search_val+'&start_date='+start_date+'&end_date='+end_date+'&status_id='+status_id)
