        ...
        <section id="dashboard">
            ...
            <div class="canvas">
                ...
                <div class="canvasHead">
					...
					<div class="canvasHeadBox2" style="background:#fff;padding:10px;border-radius:10px;display:flex;justify-content:space-between;align-items:center;width:55%;">
						...
						<div class="patinetsPrfle">
							<a href=""  class="patient_history" target="blank" style="background:#469c31cf;border-radius:8px;font-weight:500;cursor:pointer;padding:10px 25px;text-decoration:none;color:#fff;">Profile</a>
						</div>
					</div>
                </div>
                <!-- canvas head close -->
						...
						<div class="currentConsulting currentConsulting_patient" style="display:none">
							...
							<div class="currentConsultingBody">
								...
								<div class="buttonAreaList">
									...
									<button class="currentConsultingreffertoBtn">Reffer To</button>
								</div>
								<!--<div class="currentConsultingBox">
									<div class="formGroup" style="display: none;">
										<span>Gender</span>
            ...
            <div class="commentsPopupMain" style="border-top: none; margin-top: 0; padding-top: 0;">
				...
				<div id="tab1" class="commentsPopupTabBox">
					...
					<div class="commentsPopupForm">
						<h2>Add Complaints<span style="color:red;font-size:12px;">⚠️ Please DO NOT remove the space shown in front of the new line</span></h2>
