...
$.ajax({
	url:"action/hsn_report_summery.php",
	type:"POST",
...
$('body').delegate('.export_reports','click', function(e){
	...
	window.location.href="action/export_hsn_report_summery.php?start_date="+start_date+"&end_date="+end_date+"&search_data="+search_data;
