...
function fetch_all_staff(){
	$.ajax({
		url:"action/staff/fetch_all_staff_count.php",
		type:"POST",
...
$.ajax({
	url:"action/staff/fetch_all_staff.php",
	type:"POST",
	data:{search_val:search_val,
				...
				$('.tableWraper table tbody').append(`<tr>
                                                    ...
                                                    <td data-label="Action">
                                                        <div class="tableBtnArea">
                                                            <a href="edit-staff.php?id=${result_data_json[x]['id']}" class="tableEditBtn" title="Edit"><i class="uil uil-pen"></i>
                                                            </a>
