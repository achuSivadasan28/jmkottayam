...
//total invoice
$select_all_total_invoice = $obj->selectData("count(id) as id","tbl_customer","where (tbl_customer.created_date='$days1' or tbl_customer.created_date='$days')  and status!=0");
