...
if($check_security == 1){
	...
	$select_login_id = $obj->selectData("id","tbl_login","where user_name='$email' and password='$pwd_details_converted_encrypt' and phone_number='$phone_no' and role='doctor' and status=1");
