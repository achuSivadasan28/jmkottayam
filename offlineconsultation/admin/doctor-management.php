...
<body>
        ...
        <div class="filterSection">
            ...
            <div class="filterSectionBody">
                <div class="filterSectionBodyBox">
                    <h2>Department</h2>
                    <div class="filterSectionBodyCheckbox department_names">
                       <!-- <div class="formGroup">
                            <input type="checkbox" id="department1">
                            <label for="department1">Cardiology</label>
                        </div>
                        <div class="formGroup">
                            <input type="checkbox" id="department2">
                            <label for="department2">Ortho</label>
                        </div>
                        <div class="formGroup">
                            <input type="checkbox" id="department3">
                            <label for="department3">Ophthalmology</label>
                        </div>
                        <div class="formGroup">
                            <input type="checkbox" id="department4">
                            <label for="department4">Dermatology</label>
                        </div>-->
                    </div>
                </div>
                <div class="filterSectionBodyBox">
            ...
            <div class="canvas">
                ...
                <div class="canvasHead">
                    ...
                    <div class="canvasHeadBox2">
                        <a href="add-doctor.php" class="addBtn">Add Doctor</a>
                    </div>
                </div>
                <!-- canvas head close -->
                            ...
                            <div class="consultAppointmentListTable">
                                <div class="consultAppointmentListTableHead">
                                    ...
                                    <div class="filterTable">
                                        <div class="filterTableBtn" style="display:none">
                                               ...
                                               <!-- <tr>
                                                    ...
                                                    <td data-label="Action">
                                                        <div class="tableBtnArea">
                                                            <a href="view-doctor.php" class="tableViewBtn" title="View"><i class="uil uil-eye"></i>
                                                            </a>
                                                            <a href="edit-doctor.php" class="tableEditBtn" title="Edit"><i class="uil uil-pen"></i>
                                                            </a>
    ...
    <!-- script  -->
        ...
        ?>
	<script src="assets/doctor/doctor-management.js?v=<?php echo $version_variable;?>"></script>
    <!-- script close -->
