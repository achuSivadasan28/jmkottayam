...
function fetch_bill_count(){
	$.ajax({
		url:"action/fetch_bill_count_cancelled.php",
		type:"POST",
...
fetch('action/invoice_cancelled.php?search_val='+search_val+'&start_date='+start_date+'&end_date='+end_date+'&status_id='+status_id+'&limit_range='+limit_range)
