...
<body>
            ...
            <div class="deleteAlertMian">
                ...
                <div class="deleteAlertContent">
                    ...
                    <div class="deleteAlertBtnArea">
                        <div class="closedeleteAlert">Cancel</div>
                        <div class="confirmdeleteAlert" style="background: green;">Confirm</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="canvas">
                ...
                <div class="canvasHead">
					...
					<div class="canvasHeadBox2" style="margin-left: auto;">
						<a href="https://meet.google.com/" target="_blank" class="googleMeetBtn">
							<img src="assets/images/googleMeet.png" title="Open Google Meet">
						</a>
					</div>
                </div>
                <!-- canvas head close -->
    ...
    <!-- script  -->
        ...
        ?>
	<script src="assets/appointment/new-appointments-data.js?v=<?php echo $version_variable;?>"></script>
    <!-- script close -->
