...
<!-- toaster close -->
            ...
            <div class="canvas">
                ...
                <div class="dashboardPage">
                    <div class="dashboardMenuList">
                        <a href="offline-appointments.php" class="dashboardMenuBox">
                            <div class="dashboardMenuBoxIcon">
                                <i class="uil uil-calendar-alt"></i>
                            </div>
                            <div class="dashboardMenuBoxDetails">
                                <h2>Offline Appointments</h2>
                                <span><b id="appointment_count">0</b> Appointments</span>
                            </div>
                        </a>
                       <!-- <a href="online-appointments.php" class="dashboardMenuBox">
                            <div class="dashboardMenuBoxIcon">
    ...
    <!-- script  -->
        ...
        ?>
	<script src="assets/appointment/todays-appointment.js?v=<?php echo $version_variable;?>"></script>
    <!-- script close -->
