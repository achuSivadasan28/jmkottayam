...
$.ajax({
	...
	console.log(result_data_json)
		if(result_data_json[0]['status'] == 1){
			...
			$('.tableWraper table tbody').empty()
			if(result_data_json[0]['patient_id'] != undefined){
			if(result_data_json[0]['data_status'] == 1){
				...
				let print_data = ``;
				let edit_appointment = ``;
				for(let x=0;x<result_len;x++){
					si_no++;
					let appoint_status = 'Pending';
					 print_data = '';
					edit_appointment = '';
					if(result_data_json[x]['appointment_status'] == 2 || result_data_json[x]['appointment_status'] == 1){
						...
						edit_appointment = `<a href="edit-appointment.php?id=${result_data_json[x]['app_id']}" class="tableEditBtn" style="background: maroon;" title="Edit Appointment"><i class="uil uil-file-edit-alt"></i>
                                                            </a>`
				...
				$('.tableWraper table tbody').append(`<tr>
                                                    ...
                                                    <td data-label="Unique ID">
                                                        <div class="UniqueId" data-id = '${result_data_json[x]['patient_id']}' data-branch = '${result_data_json[x]['branch_id']}' title="Patient Profile" style="cursor:pointer">
                                                    ...
                                                    <td data-label="Action">
														...
														${edit_appointment}
                                                           ...
                                                           <a href="edit-appointment-details.php?id=${result_data_json[x]['app_id']}" class="tableEditBtn" title="Edit"><i class="uil uil-edit"></i>
                                                            </a>
															${print_data}
...
$('body').delegate('.UniqueId span','click',function(){
				   const patient_id = $(this).parent().data('id')
                   let branch_id = $(this).parent().data('branch')
				   window.open(`patients-profile.php?patient_id =${patient_id}/${branch_id}`)
})