...
}else if($first_part == 'reports.php' || $first_part == 'stock-analysis.php' || $first_part == 'top-selling-products.php' || $first_part == 'least-selling-products.php' || $first_part == 'invoice-reports.php' || $first_part == 'daily-reports.php' || $first_part == 'inner-daily-reports.php' || $first_part == 'cancelled-reports.php'){
