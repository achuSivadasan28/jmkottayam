...
if($check_security == 1){
	...
	$select_all_staff = $obj->selectData("id,doctor_name,department_id,login_id","tbl_doctor","where status=1  $where_search ORDER BY id DESC");
