...
$fileName = "credit_reports_trsr" . date('d-m-Y') . ".xls"; 

$fields = array('No','Invoice No','Customer Name','Phone','Returned Amount','Date');

$excelData = implode("\t", array_values($fields)) . "\n"; 


$customer = $obj1->selectData("id,invoice_id,invoice_number,credit_note_invoice_number,addedDate,addedTime","tbl_credit_note"," where status =1  $where_name_filter $date_where_clause");
...
$x++;
       $lineData = array($sino,$customer_row['credit_note_invoice_number'],$customer_name,$phone,$total_price_1,$customer_row['addedDate']); 
