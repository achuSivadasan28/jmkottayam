<?php
function login_details_mailer($mail,$to,$user_name,$user_email,$userPhn,$userPwd,$subject){
	$output1 = 0;
	$user_name_data = '';
	if($user_email !=''){
		$user_name_data = "$user_email or $userPhn";
	}else{
		$user_name_data = "$userPhn";
	}
...
$mail->SMTPDebug = SMTP::DEBUG_SERVER;                      //Enable verbose debug output
  ...
  $mail->Username   = 'counsultation@jmwell.in';                     //SMTP username
  $mail->Password   = '5b2*1nDf'; 
  ...
  $mail->Port       = 25; 
    ...
    //Recipients
    $mail->setFrom('Johnmarians@gmail.com', 'Johnmarians Email');
    $mail->AddAddress($to);
    ...
    <p style="margin: 0; font-size: 22px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 26px; margin-top: 0; margin-bottom: 0;"><span style="font-size: 20px;">Hello '.$user_name.', This is your login credantials</span></p>
    </div>
    </div>
    ...
    <p style="margin: 0; font-size: 14px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 17px; margin-top: 0; margin-bottom: 0;"><br/><span style="font-size: 16px;">Your username is : <span style="color: #1100ff; font-size: 16px;"><strong>'.$user_name_data.'</strong></span></span><span style="font-size: 16px;"></span></p>
    <p style="margin: 0; font-size: 16px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 19px; margin-top: 20px; margin-bottom: 0;"><span style="font-size: 16px;">Your Password is : <span style="color: #1100ff;"> <strong>'.$userPwd.'</strong></span></span></p>
    </div>
...
function fwd_details_mailer($mail,$to,$userPwd,$staff_name,$subject){
	$output1 = 0;
	//mail sending to staff
try {
    //Server settings
$mail->SMTPDebug = SMTP::DEBUG_SERVER;                      //Enable verbose debug output
  ...
  $mail->Port       = 25; 
    ...
    <div style="color:#132F40;font-family:Cabin, Arial, Helvetica Neue, Helvetica, sans-serif;line-height:1.2;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
    <div class="txtTinyMce-wrapper" style="font-size: 12px; line-height: 1.2; color: #132F40; font-family: Cabin, Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 14px;">
    <p style="margin: 0; font-size: 22px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 26px; margin-top: 0; margin-bottom: 0;"><span style="font-size: 20px;">Hello '.$staff_name.', This is your New Password</span></p>
    </div>
    </div>
    <!--[if mso]></td></tr></table><![endif]-->
    <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 10px; padding-left: 10px; padding-top: 5px; padding-bottom: 30px; font-family: Arial, sans-serif"><![endif]-->
    ...
    <div class="txtTinyMce-wrapper" style="font-size: 12px; line-height: 1.2; color: #555555; font-family: Cabin, Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 14px;">
    <div class="txtTinyMce-wrapper" style="font-size: 12px; line-height: 1.5; color: #555555; font-family: Cabin, Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 18px;">
    <p style="margin: 0; font-size: 14px; line-height: 1.5; word-break: break-word; mso-line-height-alt: 21px; margin-top: 0; margin-bottom: 0;">Your Password here.</p>
    </div>
    </div>
    <p style="margin: 0; font-size: 16px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 19px; margin-top: 20px; margin-bottom: 0;"><span style="font-size: 16px;">Your Password is : <span style="color: #1100ff;"> <strong>'.$userPwd.'</strong></span></span></p>
    </div>
    ...
    <div style="color:#555555;font-family:Cabin, Arial, Helvetica Neue, Helvetica, sans-serif;line-height:1.2;padding-top:15px;padding-right:10px;padding-bottom:15px;padding-left:10px;">
    <div class="txtTinyMce-wrapper" style="font-size: 12px; line-height: 1.2; color: #555555; font-family: Cabin, Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 14px;">
    <p style="margin: 0; font-size: 16px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 19px; margin-top: 0; margin-bottom: 0;"><span style="font-size: 16px;"><span style="color: #132f40; font-size: 16px;"><strong></strong></span></span></p>
    <p style="margin: 0; font-size: 16px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 19px; margin-top: 0; margin-bottom: 0;"><span style="font-size: 16px;"></span></p>
    </div>
    </div>
    <!--[if mso]></td></tr></table><![endif]-->
    <div align="left" class="button-container" style="padding-top:5px;padding-right:10px;padding-bottom:35px;padding-left:10px;">
