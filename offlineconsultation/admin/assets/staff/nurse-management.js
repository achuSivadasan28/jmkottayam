...
function fetch_all_staff(){
	$.ajax({
		url:"action/staff/fetch_all_nurse_count.php",
		type:"POST",
...
$.ajax({
	url:"action/staff/fetch_all_nurse.php",
	type:"POST",
	data:{search_val:search_val,
	...
	success:function(result){
				...
				$('.tableWraper table tbody').append(`<tr>
                                                    ...
                                                    <td data-label="Action">
                                                        <div class="tableBtnArea">
                                                            <a href="edit-nurse.php?id=${result_data_json[x]['id']}" class="tableEditBtn" title="Edit"><i class="uil uil-pen"></i>
                                                            </a>
        ...
        $('.confirmdeleteAlert').click(function(){
			$.ajax({
				url:"action/staff/delete_nurse.php",
				type:"POST",
