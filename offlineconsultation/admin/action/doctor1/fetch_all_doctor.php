...
if($branch_id_f !=0){
	...
	$select_all_doctor = $obj->selectData("id,doctor_name,phone_no,email,department_id,branch_id","tbl_doctor","where status=1  $where_search $where_dep $where_branch ORDER BY id DESC limit $limit_range");
