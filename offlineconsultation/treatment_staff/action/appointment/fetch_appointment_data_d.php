...
if($check_security == 1){
	...
	if(mysqli_num_rows($select_appointment_details)>0){
		...
		while($select_appointment_details_row = mysqli_fetch_array($select_appointment_details)){
			...
			$response_arr[$x]['whatsApp'] = $select_appointment_details_row['whatsApp'];
