      ...
      <!-- print design  -->
		<div class="printPage">
			<div class="printPageHead">
				<h1><div class="printPageHeadLogo"><img src="assets/images/johnmariansLogo.png" alt=""style="width:25%"></div> WELLNESS CLINIC</h1>
			...
			<div class="printPageFooter">
				<h1><div class="printPageFooterLogo"><img src="assets/images/johnmariansLogo.png" alt="" style="width:25%"></div> WELLNESS HOSPITAL</h1>
