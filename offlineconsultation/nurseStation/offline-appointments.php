...
<!-- toaster close -->
		...
		<div class="previuosReportPopup">
			<div class="previuosReportPopupHead">
				<div class="closePreviuosReportPopup"><i class="uil uil-multiply"></i></div>
			</div>
			<div class="previuosReportPopupBody">
				<h2>Report Name</h2>
				<p id="test_data1"></p>
				<div class="previuosReportPopupImages">
					<a href="" id="report_dataImg_link" class="previuosReportPopupImagesBox spotlight">
						<img id="report_dataImg" >
					</a>
				</div>
			</div>
		</div>
        ...
        <div class="commentsPopup" style="display:none">
            ...
            <div class="commentsPopupMain" style="border-top: none; margin-top: 0; padding-top: 0;">
				<div class="commentsPopupTabBtnArea">
					...
					<button class="tablink" onclick="openCity2(event,'tab4')" style="margin-top: 0;">Report</button>
    ...
    font-weight: 600;
    margin-top: 20px;">Prescription history</h1>
						<div class="prescriptionHistoryList" style="margin-top:10px;background:#96ffea36;border-radius:10px;padding:10px;">
				...
				<div id="tab4" class="commentsPopupTabBox">
					<h1 style="font-size: 16px;
    font-weight: 600;
    margin-top: 20px;">reports</h1>
					<div class="commentsPopupTabBoxMain" style="width: 100%; display: flex; justify-content: space-between;background:#c2f2bb45;padding:15px;border-radius:10px;margin-top:10px;">
						<div class="commentsPopupPrevious">
							
							<div class="previousReport">
								<a href="add-report.php" class="previousReportBox addReportBtn"><i class="uil uil-plus"></i> Add Report</a>
								<!--<div class="previousReportBox">
									<p>Report Name</p>
									<a href="" class="previousReportBoxIcon">
    ...
    <script>
		...
		$('.closePreviuosReportPopup').click(function(e){
			e.preventDefault();
			$('.previuosReportPopup').fadeOut();
			$('.shimmer').fadeOut();
		})
