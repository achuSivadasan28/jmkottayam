...
if($check_security == 1){
	$select_todays_appointment = $obj->selectData("count(id) as id","tbl_appointment","where doctor_id='$login_id' and appointment_date='$c_days' and status!=0 and appointment_status=0 and tbl_appointment.cross_branch_status!=1");
