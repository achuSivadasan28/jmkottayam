...
if($branch_id_f !=0){
	...
	$select_all_staff = $obj->selectData("id,staff_name,staff_phone,staff_email,branch_id","tbl_lab_staff","where status=1  $where_search $where_branch ORDER BY id DESC limit $limit_range");
