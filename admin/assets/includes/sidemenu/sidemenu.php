...
}else if($first_part == 'patient-Prescription.php'){
	$active_class_patient_list_all = 'sidemenuLinkActive';
...
else if($first_part == 'credit-note.php'){
	$active_class_credit_note = 'sidemenuLinkActive';
}
...
<div class="sidemenu">
    ...
    <ul>
		...
		<li>
            <a href="patient-Prescription.php" class="<?php echo $active_class_patient_list_all;?>">
                <div class="sidemenuIcon">
                    <i class="uil uil-accessible-icon-alt"></i>
                </div>
                <p>Patients Prescription</p>
            </a>
        </li>
		<li>
            <a href="credit-note.php" class="<?php echo $active_class_credit_note;?>">
                <div class="sidemenuIcon">
