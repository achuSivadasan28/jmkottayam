						...
						<div class="currentConsulting currentConsulting_patient">
							...
							<div class="currentConsultingBody">
								...
								<div class="buttonAreaList">
									...
									<button class="consultedBtn updateData beepBtn">
        ...
        <div class="commentsPopup">
            ...
            <div class="commentsPopupMain" style="border-top: none; margin-top: 0; padding-top: 0;">
				<div class="commentsPopupTabBtnArea">
					...
					<button class=" tablink" onclick="openCity2(event,'tab2')" style="margin-top: 0;">Lab</button>
				...
				<div id="tab1" class="commentsPopupTabBox">
					...
					<div class="commentsPopupPrevious">
						...
						<div class="prescriptionHistoryList" style="margin-top:10px">
						...
						<div class="commentsPopupPreviousMain" style="flex: 0 0 52%;">
					<div class="commentsPopupPrevious">
				...
				<div id="tab5" class="commentsPopupTabBox" >
					<div class="historyList">
						<div class="commentsPopupPrevious" style="flex: 100%">
				...
				<div id="tab3" class="commentsPopupTabBox" style="display: none;margin-top:10px">
					<div class="historyList">
...
$('div').delegate('.lab_details ul li','click',function(){
...
$('body').delegate('.closeFormTagBox', 'click', function(){
	...
	let data_id = $(this).attr('data-id')
	    //console.log()
    let theBlackSheep = thePEl.children[0].innerHTML;
	let theIdNeeded = thePEl.children[0].getAttribute('data_id');
	if(data_id != undefined){
		console.log(data_id)
		$.ajax({
			url:"action/appointment/remove_app.php",
			type:"POST",
...
// image Preview slider
	...
	<script src="assets/appointment/edit_appointment.js?v=<?php echo $v;?>"></script>
</body>
</html>
<?php
}else{
