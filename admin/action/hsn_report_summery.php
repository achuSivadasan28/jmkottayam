...
$total_taxable_value = $total_amount_final - $total_tax_amt_final;
$response_arr1[0]['total_taxable_value'] = round($total_taxable_value,2);
$response_arr1[0]['total_tax_amt'] = round($total_tax_amt_final,2);
$response_arr1[0]['total_amount'] = round($total_amount_final,2);
echo json_encode($response_arr1);
