            ...
            <div class="canvas">
                ...
                <div class="canvasHead">
                    ...
                    <div class="canvasHeadBox2">
                        <a href="add-category.php" class="addBtn">Add Category</a>
                    </div>
                </div>
                <!-- canvas head close -->
                                                ...
                                                <!-- <tr>
                                                    ...
                                                    <td data-label="Action">
                                                        <div class="tableBtnArea">
                                                            <a href="view-category.php" class="tableViewBtn" title="View"><i class="uil uil-eye"></i>
                                                            </a>
                                                            <a href="edit-category.php" class="tableEditBtn" title="Edit"><i class="uil uil-pen"></i>
                                                            </a>
...
$('body').delegate('.tableDeleteBtn','click',function(e){ 
        ...
        $('.confirmdeleteAlert').click(function(){
            let urlval = id;
                        fetch('action/delete-category.php?id=' + urlval)
...
<script src="js/category-fetch.js?v=<?php echo $version_variable;?>"></script>
<script>
