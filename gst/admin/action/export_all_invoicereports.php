...
$fileName = "Invoice_reports" . date('d-m-Y') . ".xls"; 

$fields = array('No','Invoice No','Customer Name','Phone','Products Name','Date','Staff Name','Total Amount');
...
$staff_name,$customer_row['total_amonut']); 
