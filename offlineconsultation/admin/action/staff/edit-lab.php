...
if($check_security == 1){
	...
	$val = $_POST['val'];
	$login_data_1 = 0;
	$select_log_id_1 = $obj->selectData("login_id","tbl_lab_staff","where id=$val");
	...
	$obj->updateData("tbl_lab_staff",$info_staff,"where id=$val");
	$select_log_id = $obj->selectData("login_id","tbl_lab_staff","where id=$val");
