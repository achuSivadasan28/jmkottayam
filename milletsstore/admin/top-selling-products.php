...
<body>
            ...
            <div class="canvas">
                ...
                <div class="canvasHead">
                    <div class="canvasHeadBox1">
                        <h1>Top Selling Products (Above 50%)</h1>
                    ...
                    <div class="canvasHeadBox2">
                        <a href="action/top_export.php" class="addBtn">Export Excel</a>
                    </div>
                </div>
                <!-- canvas head close -->
    ...
    <!-- script  -->
        ...
        ?>
    <!-- script close -->
 <script src="js/top-selling.js?v=<?php echo $version_variable;?>"></script>
<script>
