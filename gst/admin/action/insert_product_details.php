...
$selectData=$obj->selectData("id,product_name,quantity,status","tbl_product","where status!=0 and id=$product_id");
...
$select=$obj->selectData("id,quantity","tbl_product","where id=$product_id and status!=0");
// echo $select; exit();
...
$update=$obj->updateData("tbl_product",$info,"where id=$product_id");
echo 0;
