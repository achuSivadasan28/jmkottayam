...
if($check_security == 1){
	...
	$select_login_id = $obj->selectData("id","tbl_login","where user_name='$staff_email' and password='$pwd_details_converted_encrypt' and phone_number='$phone_no' and role='lab' and status=1");
	...
	$obj->insertData("tbl_lab_staff",$info_staff);
		}
	}
