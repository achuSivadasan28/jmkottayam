...
$fileName = "Johnmarians_Least_Selling_report_trvl" . date('Y-m-d') . ".xls"; 
...
$export_arr = array();
$x = 0;
$fetch_data = $obj1->selectData("tbl_product.id,tbl_product.product_name,tbl_product.category_id,tbl_medicine_details.quantity,tbl_medicine_details.no_of_pills","tbl_product inner join tbl_medicine_details on tbl_product.id=tbl_medicine_details.product_id","where tbl_product.status!=0  ORDER BY tbl_product.id DESC");
