            ...
            <div class="canvas">
                ...
                <div class="dashboardPage">
                    <div class="dashboardMenuList">
                        <a href="branch-management.php" class="dashboardMenuBox">
                        ...
                        <a href="department-management.php" class="dashboardMenuBox">
                            <div class="dashboardMenuBoxIcon">
                        ...
                        <a href="doctor-management.php" class="dashboardMenuBox">
                            <div class="dashboardMenuBoxIcon">
                        ...
                        <a href="staff-management.php" class="dashboardMenuBox">
                            <div class="dashboardMenuBoxIcon">
                        ...
                        <a href="core-data.php" class="dashboardMenuBox">
                            <div class="dashboardMenuBoxIcon">
						 ...
						 <a href="reports.php" class="dashboardMenuBox">
                            <div class="dashboardMenuBoxIcon">
					...
					<div style="display:flex;font-family: 'Montserrat', sans-serif;background:white;padding:15px;margin-top:10px;border-radius:5px;width:49%;box-shadow: 0 0 15px rgba(11, 10, 10, 0.046);">
						...
						<div style="display:flex;flex-direction:column;">
							<span style="margin-top:10px;" class="cardSub total_patients"></span>
							<span style="margin-top:10px;" class="cardSub total_new_patient"></span>
							<span style="margin-top:10px;" class="cardSub total_nr_patient"></span>
							<span style="margin-top:10px;" class="cardSub total_re_patient"></span>			
						</div>
							</div>
							<div>
						<h2 style="font-size: 18px;font-weight:600;color:black;color:#557bfe;">Today's collection</h2>
						<div style="display:flex;flex-direction:column;">
							<span style="margin-top:10px;" class="cardSub total_collection"></span>
							<span style="margin-top:10px;" class="cardSub total_cash"></span>
							<span style="margin-top:10px;" class="cardSub total_online"></span>	
							<span style="margin-top:10px;" class="cardSub total_card"></span>	
						</div>
								</div>
						</div>
