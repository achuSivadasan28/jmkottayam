    ...
    fetch('../admin/action/fetch-product.php')
...
$.ajax({
	url:"../admin/action/fetch_invoice_details.php",
	type:"POST",
...
$('body').delegate('.product_remove_data','click',function(){
	...
	$.ajax({
		url:"../admin/action/delete_product_data.php",
		type:"POST",
		data:{btn_id:btn_id,
			  url_val:url_val,
			  total_amt:total_amt,
...
$('body').delegate('.discount','keyup',function(){
  ...
  $.ajax({
      url:"../admin/action/discount-check.php",
      type:"POST",
      data:{id:id,
        discount:discount},
...
//out of stock    
    $('body').delegate('.Quantity','keyup',function(){
      ...
      $.ajax({
          url:"../admin/action/quantity-checking.php",
          type:"POST",
          data:{id:id,
            Quantity:Quantity},
          success:function(resultData){
	...
	$('body').delegate('.product_name_drop ul li','click',function(){
		...
		$.ajax({
           url:"../admin/action/fetch_product_data.php",
          type:"POST",
    ...
    $('body').delegate('.ProductName','keyup',function(){
      ...
      $.ajax({
          url:"../admin/action/fetch-products.php",
          type:"POST",
          data:{product_name:product_name},
          success:function(resultData){
...
function update_exist_data(){
	$('.dynamicEditProductDetails .customeInputArea').each(function(){
		...
		$.ajax({
			url:"../admin/action/update_exist_data.php",
			type:"POST",
...
function update_customer_details(customer_name,phone,place,Tprice,Tdiscount,tamount){
	return $.ajax({
		url:"../admin/action/update_customet_details.php",
		type:"POST",
    ...
    function save_product_details(customer_id){
		...
		let promise = new Promise(function(res,rej){
		   ...
		   if(ProductName != ''){
           $.ajax({
               url:"../admin/action/insert_product_details.php",
               type:"POST",
               data:{ProductName:ProductName,
     ...
     //print bill
                function printbill(customer_id) {              
                     return $.ajax({
                        url: "../admin/action/fetchbill.php",
                        type:"POST",
