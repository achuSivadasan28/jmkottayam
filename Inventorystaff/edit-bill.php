...
<body>
        ...
        <section id="dashboard">
            ...
            <div class="canvas">
                ...
                <div class="formWraper">
                    ...
                    <div class="customeInputArea edit_customer_input_new">
    ...
    <script src="js/edit_generatebills.js?v=<?php echo $version_variable;?>"> </script>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(".addNewFormGroupBtn").click(function(e) {
                ...
                let template_data = `<div class="customeInputArea edit_customer_input_new"> 
