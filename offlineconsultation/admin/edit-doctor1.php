...
<!-- toaster close -->
                ...
                <div class="formWraper">
                    <form action="" id="edit_doctor">
                        ...
                        <div class="formGroup">
                            ...
                            <input type="number" value="" id="phnNo">
                        ...
                        <div class="formBtnArea">
                            <button id="edit_doctor_btn">Save</button>
                        </div>
                    </form>
                </div>
                <!-- form section close -->
    ...
    ?>
	<script src="assets/doctor/edit-doctor.js?v=<?php echo $version_variable;?>"></script>
    <!-- script close -->
