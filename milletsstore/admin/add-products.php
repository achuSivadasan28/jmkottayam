...
<body>
            ...
            <div class="canvas">
                ...
                <div class="formWraper">
                    <form action="" id="form_act">
						...
						<div class="formTemplateDiv" style="background:#eefaee;">
							<div class="formGroup"> 
								<label for="">Weight / volume</label>
								<input type="text" class="pills_number" required>
							</div>
							<div class="formGroup">
    ...
    <script>
		...
		$('.addNewTemplateBtn').click(function(){
			...
			var formTemplateDiv = `<div class="formTemplateDiv" style="background:#eefaee;">
							<div class="formGroup">
								<label for="">Weight / volume</label>
								<input type="text" class="pills_number" required>
							</div>
