...
<body>
        ...
        <div class="deleteAlert">
            <div class="deleteAlertMian">
                ...
                <div class="deleteAlertContent">
                    <p>Confirm End Appointment</p>
                    <div class="deleteAlertBtnArea">
                        <div class="closedeleteAlert">Cancel</div>
                        <div class="confirmdeleteAlert">Confirm</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- script  -->
        ...
        ?>
	<script src="assets/appointment/scheduled-appointments-data.js?v=<?php echo $version_variable;?>"></script>
    <!-- script close -->
