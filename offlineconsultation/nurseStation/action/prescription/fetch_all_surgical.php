...
if($check_security == 1){
	...
	$select_all_comments = $obj->selectData("DISTINCT added_date","tbl_surgical_history","where patient_id='$patient_id' and status!=0 ORDER BY id DESC");
	...
	for($x = 0;$x<$date_arr_size;$x++){
		...
		$select_all_data = $obj->selectData("comment","tbl_surgical_history","where patient_id='$patient_id' and added_date = '$added_date' and status!=0 ORDER BY id DESC");
