...
if($check_security == 1){
	...
	$select_prescription_details = $obj->selectData("medicine_id,medicine_name,quantity,morning_section,noon_section,evening_section,no_of_day,remark,after_food,befor_food","tbl_prescription_medicine_data","where id=$prescription_id and status !=0");
