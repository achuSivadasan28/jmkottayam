...
<body>
	...
	<!-- Popup -->
	<div id="popupContainer" class="popup-container" style="display: none;flex-direction:column;
	position: fixed;
	top: 50%;
	left: 50%;
	...
	color: white;
	font-size: 16px;display:flex;flex-direction:column;align-items:center;justify-content:center;">
			<p style="color:black; font-size:18px;font-weight:500;margin-top:20px">Please remember to save entered data before submitting!</p>
			<span style="margin:5px 0px 20px 0px;color:red;font-size:12px;">Note: Leaving this page without saving may result in the loss of data</span>
		</div>
		<div class="popup-buttons" style="text-align: center; display: flex; justify-content: center; align-items: center;">
			<button id="goBackButton" style="margin: 0 5px;
	padding: 8px 16px;
	border: none;
	border-radius: 4px;
	color: white;
	background-color: #4CAF50;
	cursor: pointer;background-color: #f44336;">Go Back</button>
			<button id="continueButton" style="margin: 0 5px;
	padding: 8px 16px;
	border: none;
	border-radius: 4px;
	color: white;
	...
	cursor: pointer;">
			...
			<span id="proceed" class="consult_btn1 ac_btn">Proceed</span>
				<span id="loading1" class="consult_btn"></span>
									<span id="done1" class="consult_btn1" style="display:none;">Done</span>
...
<!-- toaster close -->
		...
		<!-- reffer popup -->
		<div class="refferPopup">
			<div class="refferPopupMain">
				<h2>Refer To</h2>
				<form>
					<div class="formGroup">
						...
						<div class="custom-dropdown">
							...
							<ul class="dropdown-list" id = "refer-list-drop">
								<li data-value="Dr Manoj Johnson">Dr Manoj Johnson</li>
								<li data-value="Dr Marian">Dr Marian</li>
								<!-- Add more options here -->
							</ul>
						</div>
						<span class="referdateerror" style="font-size:small;color:red;"></span>
					</div>
					<div class="formDateCheckbox">
						<h3>Choose Date</h3>
						<!--<ul>
							<li>
								...
								<div class="formDateCheckboxNotiIcon">10</div>
							</li>
							<li>
					...
					<div class="formBtnArea">
						<div class="closeRefferPopup">Close</div>
						<button class="saveRefferData" disabled>Refer To</button>
					</div>
				</form>
			</div>
		</div>
					...
					<div class="consultingWindowHead">
						<div class="currentConsulting currentConsulting_patient" style="display:none">
							<div class="currentConsultinghead">
								...
								<span id="first_v" style="padding: 5px 15px; border-radius: 5px; color: #72147E; font-weight: 500; font-size: 12px; background: #eee;">First visit :<span id='dofv'></span></span>
							...
							<div class="currentConsultingBody">
								...
								<div class="buttonAreaList">
									...
									<button class="currentConsultingreffertoBtn" >Refer To</button>
								</div>
								<!--<div class="currentConsultingBox">
									<div class="formGroup" style="display: none;">
										<span>Gender</span>
            ...
            <div class="commentsPopupMain" style="border-top: none; margin-top: 0; padding-top: 0;">
				...
				<div id="tab1" class="commentsPopupTabBox">
					...
					<div class="commentsPopupForm">
						<h2>Add Complaints <span style="color:red;font-size:12px; font-weight: 400; margin-left: 20px;">⚠️ Please DO NOT remove the space shown in front of the new line</span></h2>
				...
				<div id="tab4" class="commentsPopupTabBox" style="display: none;">
					<div class="historyList">
						<div class="commentsPopupPrevious" style="flex: 100%">
							...
							<!--<div class="formWraperBox">
							<div class="formTagArea selected_lab_report">
                                    
                            </div>
								<div class="formGroup">
									<label for="" style="font-size:12px;margin-bottom:5px;">Select Lab Tests</label>
									<div class="dropDownSection">
										...
										<div class="dropDownPopup">
											...
											<div class="dropDownPopuplist multipleSelect lab_report">
												<ul>
													<li data-id=1>a</li>
													<li data-id=2>b</li>
													<li data-id=3>c</li>
						...
						<div class="commentsPopupPrevious" style="flex: 100%">
							...
							<div class="formTagArea selected_treatment_report">
								...
								<div class="formGroup">
									...
									<div class="dropDownSection">
										<div class="dropDownInput">
											<input type="text" class="dropDownInputText" disabled style="position:relative;z-index:-1;">
										</div>
				...
				<div id="tab6" class="commentsPopupTabBox" style="display: none;">
					...
					<div class="commentsPopupForm edit_data_DN">
						<h2>Edit Note   <p style="color:red">"You are allowed to edit notes only in this area, and notes can only be added through the "Remark(Doctor)" section."</p></h2>
						<form action="">
				...
				<div id="tab7" class="commentsPopupTabBox" style="display: none;">
					...
					<div class="canvasHead">
						...
						<div class="canvasHeadBox2" style="background:#fff;padding:10px;border-radius:10px;display:flex;justify-content:space-between;align-items:center;width:auto;">
							<div class="canvasHeadToggle" >
								<label class="switch">
									<input type="checkbox" class="all_appointment">
									<span class="slider"></span>
								</label> &nbsp; Switch Appointments
							</div>
							<div class="patinetsPrfle">
								<a href="" class="patient_history" target="blank" style="background:#469c31cf;border-radius:8px;font-weight:500;cursor:pointer;padding:10px 25px;text-decoration:none;color:#fff; display: none;">Profile</a>
							</div>
						</div>
					</div>
					<!-- canvas head close -->
                    <div class="consultAppointmentList">
                        ...
                        <div id="appointmentTab1" class="tabcontent" style="display: block;">
                            <div class="consultAppointmentListTable">
								...
								<h2 style="font-size: 20px; font-weight: 500;"></h2>
    ...
    <script>
		...
		// closeRefferPopup
		$('.closeRefferPopup').click(function(){
			$('.refferPopup').fadeOut();
			$('.shimmer').fadeOut();
		})
		...
		$(document).ready(function () {
			...
			var imagePos = $(this).parent('.custom-dropdown').offset().top;
			var topOfWindow = $(window).scrollTop();
			if (imagePos < topOfWindow+700) {
				$('.dropdown-list').removeClass('dropDownPopupUp');
				$('.dropdown-list').removeClass('dropDownPopupDown');
				$(this).parent().find('.dropdown-list').addClass('dropDownPopupDown');
				$('.custom-dropdown input').css({
					boxShadow: 'none',
				})
				$(this).find('input').css({
				...
				$('.dropdown-list').removeClass('dropDownPopupUp');
				$('.dropdown-list').removeClass('dropDownPopupDown');
				$(this).parent().find('.dropdown-list').addClass('dropDownPopupUp');
...
for(let j=0; j<namesArr1.length;j++){
	if(namesArr1[j].data_id === theIdNeeded){
		const index = namesArr1.indexOf(namesArr1[j]);
				//console.log(index)
				if (index > -1) {
					namesArr1.splice(index, 1); 
				  }
									...
									<div class="formGroupFile">
										<div class="formGroupFileMain">
											<div class="formGroupFileBox1">
												<label>Upload File</label>
												<label class="uploadBtn">
  													<input type="file" class="fileInput report_file" multiple>
                                                    <p>Upload images</p>
                                                </label>
												<span style="color:red" class="file_error"></span>
											</div>
...
$('#goBackButton').click(function(){
		...
		$(".currentConsultingreffertoBtn").click(()=>{
