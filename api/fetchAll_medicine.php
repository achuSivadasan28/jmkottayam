...
if($api_val == $apival){
	...
	$response_arr[0]['msg'] = "success";
		$select_medicine_name = $obj->selectData("tbl_product.id,tbl_product.product_name,tbl_product.quantity","tbl_product inner join tbl_category on tbl_product.category_id=tbl_category.id","where tbl_product.status!=0 and tbl_category.status!=0");
