...
<body>
            ...
            <div class="canvas">
                ...
                <div class="canvasHead">
                    ...
                    <div class="canvasHeadBox2">
                        <a href="add-staff.php" class="addBtn">Add Nurse</a>
                    </div>
                </div>
                <!-- canvas head close -->
                ...
                <div class="consultingWindow">
                    <div class="consultAppointmentList">
                        ...
                        <a href="add-nurse.php" class="addBtn">Add Nurse</a>
                                </div>
    ...
    <!-- script  -->
        ...
        ?>
	<script src="assets/staff/nurse-management.js?v=<?php echo $version_variable;?>"></script>
    <!-- script close -->
