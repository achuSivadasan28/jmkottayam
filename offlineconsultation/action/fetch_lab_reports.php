...
$id = '';
$lab_report_file = '';
 $select_all_reports_date = $obj_branch->selectData("DISTINCT added_date","tbl_add_lab_data","where patient_id=$patient_id and status!=0");
if(mysqli_num_rows($select_all_reports_date)>0){
	...
	while($select_all_reports_date_row = mysqli_fetch_array($select_all_reports_date)){
		...
		$select_all_reports = $obj_branch->selectData("test_name,id,lab_report_file","tbl_add_lab_data","where added_date='$added_date' and patient_id=$patient_id");
