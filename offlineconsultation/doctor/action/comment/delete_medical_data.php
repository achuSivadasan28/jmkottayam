...
if($check_security == 1){
	...
	$obj_branch->updateData("tbl_medical_history",$info_comment,"where id=$comment_id");
	$select_pid = $obj_branch->selectData("patient_id","tbl_medical_history","where id=$comment_id");
