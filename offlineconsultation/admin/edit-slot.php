...
<!-- toaster close -->
        ...
        <section id="dashboard">
            ...
            <div class="canvas">
                ...
                <div class="canvasHead">
                    <div class="canvasHeadBox1">
                        ...
                        <div class="breadCrumbs">
                            <a href="appointment-slot.php" class="back"><i class="uil uil-angle-left-b"></i></a>
                            <span>/</span>
                            <a href="core-data.php">Core Data</a>
                            <span>/</span>
                            <a href="appointment-slot.php">Appointment Slot</a>
                        </div>
                    </div>
                </div>
                <!-- canvas head close -->
                ...
                <div class="formWraper">
                    <form action="" id="edit-time-slot">
						<div class="formGroup">
                            <label for="">Time Slot Name</label>
                            <input type="text" id="time_slot_name" required>
                        </div>
                        <div class="formGroup">
                        ...
                        <div class="formGroup">
                            ...
                            <input type="number" value="" id="time-slot">
                        </div>
                        ...
                        <div class="formBtnArea">
                            <button id="time_slot_btn">Save</button>
                        </div>
                    </form>
                </div>
                <!-- form section close -->
    ...
    ?>
	<script src="assets/timeSlot/edit-time-slot.js?v=<?php echo $version_variable;?>"></script>
    <!-- script close -->
